...
/* THIS FILE IS WRITTEN TO RUN BOTH BASE `uint32_t` AND `uint32_t` OF ADDITION.
   SUBTRACTION, MULTIPLICATION, AND DIVISION. HOWEVER, THE CURRENT TESTING
   METHODOLOGY REVOLVES AROUND `uint64_t`, SO THERE ARE A LOT OF OUTCOMMENTED
   CODE THROUGHOUT THE FILE; KEPT FOR ADAPTABILITY.
*/
