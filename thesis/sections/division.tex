...
We startet by writing a prototype of the algorithm in C to better understand the
...
\item \textbf{Base Powers}\\
  ...
  big integer, and hence, can be optmized to a constant work check on the
  integer.
...
\item \textbf{Initial Approximation}\\
  ...
  effeciently using register arithmetics, if we have access to registers of
  4$\times$ base size.
