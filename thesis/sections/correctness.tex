...
versions of \textit{convmul} (multiplication). \uuline{All tests validates}.
...
respectively. \uuline{Tests for addition, subtraction, and multiplication does
  validate -- tests for division does not validate}.
...
\ref{subsec:benchset}. \uuline{All tests validate}.
