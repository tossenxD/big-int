...
In this section, we first assess the \textit{classical} multiplication algorithm
...
multiplier at a time. E.g. in decimal system, $42\cdot 21$ becomes
...
linear in $k$, and the overflows can be added as a separate step after the
...
In order to propagate the overflows in a separate sweep, we must keep track of
