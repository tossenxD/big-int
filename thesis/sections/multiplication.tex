...
\ref{subsec:mulother} we give an overview of assymptoticly better algorithms
...
have the dominant occourance over single precision (because we are in the domain
...
{\red [Write about FFT and mention Karatsuba.]}
