...
$O(m)$ and span $O(\log m)$. It is computationally efficient, and only require
...
multiplication to work $O(m^2)$ and span $O(m)$. It is a computationally
...
{\red <TODO REF MISSING>}, we use their metric:
\begin{equation}
  \label{eq:u32ops}
